...
import { turbo } from '../controls/controls';

// fragmentShader from: https://docs.pmnd.rs/react-postprocessing/effects/custom-effects
...
class MotionBlurImpl extends Effect {
  ...
  update() {
    this.uniforms.get('strength').value = turbo * 10;
  }
}
